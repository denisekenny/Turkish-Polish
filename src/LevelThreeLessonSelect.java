...
public class LevelThreeLessonSelect extends JFrame {
	 ...
	 * Create the frame.
	 */
	public LevelThreeLessonSelect(Account paramUserAttemptingThisLesson) {
		...
		btnLessonOne.addMouseListener(new MouseAdapter() {
			...
			{
				lessonButtonClicked("lessons/levelThreeLessonOneVerbsTwo.txt");
			}
		...
		btnLessonTwo.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				lessonButtonClicked("lessons/levelThreeLessonTwoQuestions.txt");
			}
		});
		...
		btnLessonThree.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				lessonButtonClicked("lessons/levelThreeLessonThreeAnimalsTwo.txt");
			}
		});
		...
		btnLessonFour.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				lessonButtonClicked("lessons/levelThreeLessonFourFoodTwo.txt");
			}
		});
		...
		btnLessonFive.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				lessonButtonClicked("lessons/levelThreeLessonFiveVerbsThree.txt");
			}
		});
		...
		btnLessonSix.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				lessonButtonClicked("lessons/levelThreeLessonSixClothes.txt");
			}
		});
		...
		JLabel lblNumbers = new JLabel("Animals Two:");
		...
		JLabel lblPronouns = new JLabel("Verbs Two:");
		...
		JLabel lblColours = new JLabel("Food Two:");
		...
		JLabel lblAnimals = new JLabel("Verbs Three:");
